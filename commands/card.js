...
const getRobotEffect = (cardRobot) => {
    ...
    if (cardRobot.Aquatic)
        list.push("Aquatique")
    if (cardRobot.Earthly)
        list.push("Terrestre")
    if (cardRobot.Flying)
        list.push("Aérien")
    if (cardRobot.Devastation)
        list.push("Dévastation")
    if (cardRobot.Affinity)
        list.push("Affinitée")
    if (cardRobot.Tinker)
        list.push("Stoïcisme")
    if (cardRobot.Protection)
        list.push("Protection")
    if (cardRobot.Celerity)
        list.push("Esquive")
    if (cardRobot.Melee)
        list.push("Mélée")
